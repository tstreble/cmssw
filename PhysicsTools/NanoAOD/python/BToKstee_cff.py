...
BToKsteeTable=cms.EDProducer("SimpleCompositeCandidateFlatTableProducer", 
                             ...
                             variables=cms.PSet(
                                ...
                                pt=Var("userFloat('pt')", float,doc="pt of BToKstee candidate (4-trk refitted)"),
                                eta=Var("userFloat('eta')", float,doc="eta of BToKstee candidate (4-trk refitted)"),
                                phi=Var("userFloat('phi')", float,doc="phi of BToKstee candidate (4-trk refitted)"),
                                mass=Var("userFloat('mass')", float,doc="mass of BToKstee candidate (4-trk refitted)"),
                                mass_err=Var("userFloat('mass_err')", float,doc="error on mass of BToKstee candidate (4-trk refitted)"),
                                Lxy=Var("userFloat('Lxy')", float,doc="significance of BToKstee vertex-beamspot xy-separation (4-trk refitted)"),
                                CL_vtx=Var("userFloat('CL_vtx')", float,doc="BToKstee chi2 vertex probability (4-trk refitted)"),
