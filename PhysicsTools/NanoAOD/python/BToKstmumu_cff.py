...
BToKstmumuTable=cms.EDProducer("SimpleCompositeCandidateFlatTableProducer", 
                               ...
                               variables=cms.PSet(
                                ...
                                mu1_dxy=Var("daughter('mu1').dB('PV2D')", float,doc="dxy of leading muon (with sign) wrt first PV, in cm"),
                                mu1_dz=Var("daughter('mu1').dB('PVDZ')", float,doc="dz of leading muon (with sign) wrt first PV, in cm"),
                                ...
                                mu2_dxy=Var("daughter('mu2').dB('PV2D')", float,doc="dxy of subleading muon (with sign) wrt first PV, in cm"),
                                mu2_dz=Var("daughter('mu2').dB('PVDZ')", float,doc="dz of subleading muon (with sign) wrt first PV, in cm"),
                                ...
                                pt=Var("userFloat('pt')", float,doc="pt of BToKstmumu candidate (4-trk refitted)"),
                                eta=Var("userFloat('eta')", float,doc="eta of BToKstmumu candidate (4-trk refitted)"),
                                phi=Var("userFloat('phi')", float,doc="phi of BToKstmumu candidate (4-trk refitted)"),
                                mass=Var("userFloat('mass')", float,doc="mass of BToKstmumu candidate (4-trk refitted)"),
                                mass_err=Var("userFloat('mass_err')", float,doc="error on mass of BToKstmumu candidate (4-trk refitted)"),
                                Lxy=Var("userFloat('Lxy')", float,doc="significance of BToKstmumu vertex-beamspot xy-separation (4-trk refitted)"),
                                CL_vtx=Var("userFloat('CL_vtx')", float,doc="BToKstmumu chi2 vertex probability (4-trk refitted)"),
                                cosAlpha=Var("userFloat('cosAlpha')", float,doc="cosine of angle between BToKmumu momentum and vertex-beamspot separation (4-trk refitted)"),
