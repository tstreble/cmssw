...
from PhysicsTools.NanoAOD.BToKeTrk_cff import *
...
nanoSequence = cms.Sequence(
        ...
        linkedObjects  +
        BToKmumuSequence + BToKeeSequence + BToKeTrkSequence + BToKpipiSequence + PFCandSequence +
        jetTables + muonTables + tauTables + electronTables + photonTables +  globalTables +vertexTables+ metTables+simpleCleanerTable + triggerObjectTables + isoTrackTables + BToKmumuTables + BToKeeTables + BToKeTrkTables + BToKpipiTables + PFCandTables +
	l1bits)
