...
caloStage2Params.egShapeIdLUTFile           = cms.FileInPath("L1Trigger/L1TCalorimeter/data/shapeIdentification_adapt0.75_compressedieta_compressedE_compressedshape_v16.04.01.txt")
