...
HGCalTriggerCellTowerMapCodecImpl::
HGCalTriggerCellTowerMapCodecImpl(const edm::ParameterSet& conf) :
...
std::vector<bool>
HGCalTriggerCellTowerMapCodecImpl::
encode(const HGCalTriggerCellTowerMapCodecImpl::data_type& data, const HGCalTriggerGeometryBase& geometry) const 
{
...
HGCalTriggerCellTowerMapCodecImpl::data_type 
HGCalTriggerCellTowerMapCodecImpl::
...
triggerCellSums(const HGCalTriggerGeometryBase& geometry,  const std::vector<std::pair<DetId, uint32_t > >& linearized_dataframes, data_type& data)
{
	...
	l1t::HGCalTriggerCell TC ( data.payload.back() );
...
l1t::HGCalTriggerTowerMap*
HGCalTriggerCellTowerMapCodecImpl::
getTowerMap_(l1t::HGCalTriggerCell TC)
{
